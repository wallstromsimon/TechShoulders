...
1. <span id="source-1"></span>Harvard Collection of Historical Scientific Instruments. ["Harvard Mark 1."](https://chsi.harvard.edu/harvard-mark-1) History and specifications.
2. <span id="source-2"></span>Wikipedia. ["Harvard architecture."](https://en.wikipedia.org/wiki/Harvard_architecture) The architectural distinction named for the Mark I.
