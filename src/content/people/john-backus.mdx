...
1. <span id="source-1"></span>Computer History Museum. ["John
   Backus."](https://computerhistory.org/profile/john-backus/) Biography and career history.
2. <span id="source-2"></span>Wikipedia. ["Fortran."](https://en.wikipedia.org/wiki/Fortran) History
   of FORTRAN development.
3. <span id="source-3"></span>ACM. ["Can Programming Be Liberated from the von Neumann
   Style?"](https://dl.acm.org/doi/10.1145/359576.359579) Backus's 1977 Turing Award lecture.
