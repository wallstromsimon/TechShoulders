...
1. <span id="source-1"></span>Wikipedia. ["Michael Stonebraker."](https://en.wikipedia.org/wiki/Michael_Stonebraker) Biography and career.
2. <span id="source-2"></span>ACM. ["Michael Stonebraker - A.M. Turing Award Laureate."](https://amturing.acm.org/award_winners/stonebraker_1172121.cfm) Turing Award profile.
3. <span id="source-3"></span>MIT CSAIL. ["Michael Stonebraker."](https://www.csail.mit.edu/person/michael-stonebraker) Faculty profile.
