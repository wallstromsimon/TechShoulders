...
1. <span id="source-1"></span>Levy, Steven.
   ["Crypto."](https://www.penguinrandomhouse.com/books/178855/crypto-by-steven-levy/) The story of
   Diffie, Hellman, and the cypherpunks.
2. <span id="source-2"></span>ACM. ["Whitfield Diffie - A.M. Turing Award
   Laureate."](https://amturing.acm.org/award_winners/diffie_8371646.cfm) Turing Award biography.
3. <span id="source-3"></span>EFF. ["A History of Protecting Freedom Where Law and Technology
   Collide."](https://www.eff.org/about/history) The Crypto Wars and Diffie's role.
