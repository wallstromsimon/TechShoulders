...
1. <span id="source-1"></span>Internet Hall of Fame. ["Vint Cerf."](https://www.internethalloffame.org/inductees/vint-cerf) 2012.
2. <span id="source-2"></span>Cerf, V., Kahn, R. ["A Protocol for Packet Network Intercommunication."](https://ieeexplore.ieee.org/document/1092259) IEEE Transactions on Communications, 1974.
