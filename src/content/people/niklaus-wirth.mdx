...
1. <span id="source-1"></span>Wikipedia. ["Niklaus
   Wirth."](https://en.wikipedia.org/wiki/Niklaus_Wirth) Biography and career history.
2. <span id="source-2"></span>ACM Turing Award. ["Niklaus
   Wirth."](https://amturing.acm.org/award_winners/wirth_1025774.cfm) Turing Award citation and
   accomplishments.
