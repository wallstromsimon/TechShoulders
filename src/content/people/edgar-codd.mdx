...
- **Declarative queries**: Describing *what* data you want, not *how* to get it
...
1. <span id="source-1"></span>Wikipedia. ["Edgar F. Codd."](https://en.wikipedia.org/wiki/Edgar_F._Codd) Biography and career.
2. <span id="source-2"></span>ACM. ["Edgar F. Codd - A.M. Turing Award Laureate."](https://amturing.acm.org/award_winners/codd_1000892.cfm) Turing Award citation.
