...
1. <span id="source-1"></span>Stanford Engineering. ["Martin
   Hellman."](https://ee.stanford.edu/~hellman/) Hellman's academic page and publications.
2. <span id="source-2"></span>ACM. ["Martin E. Hellman - A.M. Turing Award
   Laureate."](https://amturing.acm.org/award_winners/hellman_4055781.cfm) Turing Award biography.
3. <span id="source-3"></span>Levy, Steven.
   ["Crypto."](https://www.penguinrandomhouse.com/books/178855/crypto-by-steven-levy/) History of
   public cryptography and the NSA conflicts.
