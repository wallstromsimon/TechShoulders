...
1. <span id="source-1"></span>Wikipedia. ["Barbara
   Liskov."](https://en.wikipedia.org/wiki/Barbara_Liskov) Biography and career history.
2. <span id="source-2"></span>MIT CSAIL. ["Barbara
   Liskov."](https://www.csail.mit.edu/person/barbara-liskov) MIT faculty profile.
3. <span id="source-3"></span>ACM Turing Award. ["Barbara
   Liskov."](https://amturing.acm.org/award_winners/liskov_1108679.cfm) Turing Award citation.
