...
1. <span id="source-1"></span>Wikipedia. ["Ada
   Lovelace."](https://en.wikipedia.org/wiki/Ada_Lovelace) Documents the scope of Ada's notes
   relative to Menabrea's article.
2. <span id="source-2"></span>NIST. ["Ada Lovelace: The World's First Computer
   Programmer."](https://www.nist.gov/blogs/taking-measure/ada-lovelace-worlds-first-computer-programmer-who-predicted-artificial)
   Describes Note G and its significance.
3. <span id="source-3"></span>Max Planck Society. ["Ada Lovelace and the first computer
   programme."](https://www.mpg.de/female-pioneers-of-science/Ada-Lovelace) Quotes Ada's vision of
