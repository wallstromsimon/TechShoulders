...
1. <span id="source-1"></span>Hafner, Katie; Lyon, Matthew. ["Where Wizards Stay Up Late: The Origins of the Internet."](https://en.wikipedia.org/wiki/Where_Wizards_Stay_Up_Late) Simon & Schuster, 1996.
2. <span id="source-2"></span>UCLA. ["First ARPANET transmission."](https://www.lk.cs.ucla.edu/internet_first_words.html) Kleinrock Center for Internet Studies.