...
1. <span id="source-1"></span>Wikipedia. ["IBM System R."](https://en.wikipedia.org/wiki/IBM_System_R) History and development.
2. <span id="source-2"></span>Chamberlin, Donald. ["Early History of SQL."](https://ieeexplore.ieee.org/document/6359709) IEEE Annals of the History of Computing, 2012.
