...
1. <span id="source-1"></span>Wikipedia. ["Ingres (database)."](https://en.wikipedia.org/wiki/Ingres_(database)) History and impact.
2. <span id="source-2"></span>Stonebraker, Michael. ["The Land Sharks Are on the Squawk Box."](https://cacm.acm.org/research/the-land-sharks-are-on-the-squawk-box/) Reflections on database history.
