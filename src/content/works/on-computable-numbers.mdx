...
1. <span id="source-1"></span>Stanford Encyclopedia of Philosophy. ["Turing Machines."](https://plato.stanford.edu/entries/turing-machine/) Comprehensive explanation of Turing machines and their significance.
2. <span id="source-2"></span>Wikipedia. ["On Computable Numbers."](https://en.wikipedia.org/wiki/On_Computable_Numbers,_with_an_Application_to_the_Entscheidungsproblem) Overview of the paper's key results and historical context.
