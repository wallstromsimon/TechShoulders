...
1. <span id="source-1"></span>Wikipedia. ["Oberon (programming
   language)."](https://en.wikipedia.org/wiki/Oberon_(programming_language)) Language history and
   design.
2. <span id="source-2"></span>Project Oberon. ["Project Oberon."](https://www.projectoberon.net/)
