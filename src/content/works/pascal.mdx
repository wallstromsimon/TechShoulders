...
1. <span id="source-1"></span>Wikipedia. ["Pascal (programming language)."](https://en.wikipedia.org/wiki/Pascal_(programming_language)) Comprehensive history and features.
2. <span id="source-2"></span>Computer History Museum. ["Turbo Pascal."](https://computerhistory.org/blog/the-turbo-pascal-phenomenon/) History of Borland's influential implementation.
