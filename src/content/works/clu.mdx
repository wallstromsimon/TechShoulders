...
1. <span id="source-1"></span>Wikipedia. ["CLU (programming language)."](https://en.wikipedia.org/wiki/CLU_(programming_language)) Language history and features.
2. <span id="source-2"></span>MIT. ["CLU Reference Manual."](https://pmg.csail.mit.edu/CLU.html) Original documentation.
