...
1. <span id="source-1"></span>Wikipedia. ["Diffie–Hellman key
   exchange."](https://en.wikipedia.org/wiki/Diffie%E2%80%93Hellman_key_exchange) Overview of the
   key exchange protocol.
2. <span id="source-2"></span>Stanford. ["New Directions in
   Cryptography."](https://ee.stanford.edu/~hellman/publications/24.pdf) Original paper by Diffie
   and Hellman.
3. <span id="source-3"></span>ACM. ["Diffie and Hellman Win 2015 ACM A.M. Turing
   Award."](https://amturing.acm.org/award_winners/diffie_8371646.cfm) Turing Award announcement.
