...
1. <span id="source-1"></span>ACM. ["Edgar F. Codd - A.M. Turing Award Laureate."](https://amturing.acm.org/award_winners/codd_1000892.cfm) Turing Award citation.
2. <span id="source-2"></span>Wikipedia. ["Edgar F. Codd."](https://en.wikipedia.org/wiki/Edgar_F._Codd) Biography and impact.
