...
**Declarative, Not Procedural**: Users specify _what_ data they want, not _how_ to get it. `SELECT name FROM employees WHERE salary > 50000` describes the desired result; the database determines the optimal retrieval method.
...
1. <span id="source-1"></span>Chamberlin, Donald. ["Early History of
   SQL."](https://ieeexplore.ieee.org/document/6359709) IEEE Annals of the History of Computing,
   2012.
2. <span id="source-2"></span>Wikipedia. ["SQL."](https://en.wikipedia.org/wiki/SQL) Overview and
   history.
