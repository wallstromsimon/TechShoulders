...
1. <span id="source-1"></span>Computer History Museum. ["The
   ...
   exclamation.
2. <span id="source-2"></span>Wikipedia. ["Difference
   engine."](https://en.wikipedia.org/wiki/Difference_engine) Explains the mathematical method of
   finite differences.
3. <span id="source-3"></span>Science Museum. ["Charles Babbage's Difference
   ...
   Details the 1991 reconstruction.
