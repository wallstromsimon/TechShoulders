...
1. <span id="source-1"></span>Cerf, V., Kahn, R. ["A Protocol for Packet Network Intercommunication."](https://ieeexplore.ieee.org/document/1092259) IEEE Transactions on Communications, 1974.
2. <span id="source-2"></span>Ronda Hauben. ["From the ARPANET to the Internet."](https://www.columbia.edu/~rh120/other/tcpdigest_paper.txt) TCP Digest, 2001.