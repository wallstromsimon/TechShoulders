...
1. <span id="source-1"></span>Computer History Museum. ["COBOL is 65 Years Old."](https://computerhistory.org/blog/cobol-is-65-years-old/) History of COBOL's development and the CODASYL consortium.
2. <span id="source-2"></span>Wikipedia. ["COBOL."](https://en.wikipedia.org/wiki/COBOL) Comprehensive overview of COBOL's design and features.
3. <span id="source-3"></span>Reuters. ["Wanted urgently: People who know a half century-old computer language."](https://www.reuters.com/article/us-health-coronavirus-usa-cobol-idUSKBN21K1EY) 2020 article on COBOL's continued critical role.
