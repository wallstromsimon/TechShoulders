...
1. <span id="source-1"></span>Wikipedia. ["Liskov substitution principle."](https://en.wikipedia.org/wiki/Liskov_substitution_principle) History and explanation.
2. <span id="source-2"></span>ACM. ["Data Abstraction and Hierarchy."](https://dl.acm.org/doi/10.1145/62139.62141) Liskov's 1987 OOPSLA keynote.
