...
1. <span id="source-1"></span>Computer History Museum. ["FORTRAN: The First High-Level
   Language."](https://computerhistory.org/blog/fortran-the-first-high-level-language/) History of
   FORTRAN's development.
2. <span id="source-2"></span>Wikipedia. ["Fortran."](https://en.wikipedia.org/wiki/Fortran)
   Comprehensive overview of FORTRAN's features and evolution.
